...
<table class='table table-hover table-striped table-condensed ' style="width:100%;">
	<c:choose>
		...
		<tr>
            ...
            <th class="right"><a    href="?op=history&domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&reportType=${payload.reportType}&sort=99line${model.customDate}">99Line</a>(ms)</th>
			<th class="right"><a	href="?op=history&domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&reportType=${payload.reportType}&sort=999line${model.customDate}">99.9Line</a>(ms)</th>
		...
		<tr><th  style="text-align:left;" colspan="14">
            ...
            <th class="right"><a    href="?op=history&domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&reportType=${payload.reportType}&type=${payload.encodedType}&sort=99line${model.customDate}&queryname=${model.queryName}">99Line</a>(ms)</th>
			<th class="right"><a	href="?op=history&domain=${model.domain}&date=${model.date}&ip=${model.ipAddress}&reportType=${payload.reportType}&type=${payload.encodedType}&sort=999line${model.customDate}&queryname=${model.queryName}">99.9Line</a>(ms)</th>
